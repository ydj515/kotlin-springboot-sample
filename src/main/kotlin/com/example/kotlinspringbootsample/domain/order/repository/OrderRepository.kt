...
interface OrderRepository : JpaRepository<Order, Long> {
    ...
    fun findPageWithoutBuyer(pageable: Pageable): Page<Order>

    @EntityGraph(attributePaths = ["buyer"])
    fun findAllByBuyerUsernameAndDeletedAtIsNull(buyerUsername: String, pageable: Pageable): Page<Order>

    @EntityGraph(attributePaths = ["buyer"])
    fun findAllByDeletedAtIsNullAndStatus(status: OrderStatus, pageable: Pageable): Page<Order>

    @EntityGraph(attributePaths = ["buyer"])
    fun findAllByBuyerUsernameAndStatusAndDeletedAtIsNull(
    ...
    @Query(
        ...
        where o.deletedAt is null
          and (:buyerUsername is null or b.username = :buyerUsername)
